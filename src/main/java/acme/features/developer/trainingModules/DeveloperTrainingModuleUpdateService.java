...
@Service
public class DeveloperTrainingModuleUpdateService extends AbstractService<Developer, Training> {
	...
	public void unbind(final Training object) {
		...
		dataset = super.unbind(object, "code", "moment", "details", "difficultyLevel", "updateMoment", "link", "estimatedTotalTime", "draftMode", "project");
