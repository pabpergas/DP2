...
<acme:list>
    <acme:list-column code="administrator.banner.list.label.instantationMoment" path="instantationMoment" width="5%"/>
    ...
    <acme:list-column code="administrator.banner.list.label.documentLink" path="documentLink" width="20%"/>
</acme:list>