...
<%@tag body-content="empty" import="java.util.Collection, acme.client.helpers.JspHelper"%>
...
<%@attribute name="choices" required="true" type="acme.client.views.SelectChoices"%>
...
<div class="form-group">
	...
	<select id="${path}$proxy" name="${path}$proxy" class="form-control selectpicker show-tick" 
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		option = $(this).find("#${path}\\\\$proxy :selected");
		key = option.val();
